  ...
  return (
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-20">
      <article className="prose prose-gray max-w-none dark:prose-invert">
        ...
        <p className="text-muted-foreground mb-8">Last updated: July 13, 2025</p>

        <h2 className="text-2xl font-semibold mb-4">1. Introduction</h2>
        <p>
          Welcome to PulseCloud. We are committed to protecting your privacy. This Privacy Policy explains how we
        ...
        <h3 className="text-xl font-semibold mb-2 mt-6">Financial Data</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mb-2 mt-6">By Law or to Protect Rights</h3>
        <p>
          If we believe the release of information about you is necessary to respond to legal process, to investigate or
          remedy potential violations of our policies, or to protect the rights, property, or safety of others, we may
          share your information as permitted or required by any applicable law, rule, or regulation.
        </p>
        <h3 className="text-xl font-semibold mb-2 mt-6">Third-Party Service Providers</h3>
        <p>
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">5. Security of Your Information</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">6. Policy for Children</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mb-4 mt-8">7. Changes to This Privacy Policy</h2>
        <p>
        ...
        <ul>
          <li>By email: support@pulsecloud.com</li>
          <li>
            By visiting this page on our website:{" "}
            <Link href="/contact" className="text-primary hover:underline">
              www.pulsecloud.com/contact
            </Link>
          </li>
        </ul>
      </article>
