import { type LucideIcon, Cloud, DollarSign, Shield, Zap, BarChart, Clock } from "lucide-react"
...
export const features: Feature[] = [
  {
    ...
    description: "Mine cryptocurrencies without owning or maintaining physical hardware.",
    icon: Cloud,
  },
  {
    title: "Daily Payouts",
  ...
  },
  {
    ...
    description: "Your assets and data are protected with state-of-the-art encryption and security measures.",
    icon: Shield,
  },
  {
    title: "High Hash Rate",
    description: "Access powerful mining rigs for maximum efficiency and profitability.",
    icon: Zap,
  },
  {
    title: "Real-time Statistics",
    description: "Monitor your mining performance and earnings with live, detailed statistics.",
    icon: BarChart,
  },
  {
    title: "24/7 Support",
